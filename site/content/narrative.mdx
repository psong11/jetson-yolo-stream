...
<Image
  src="/images/recommission_2026-08/self_portrait.jpg"
  alt="The desk at midnight — a MacBook showing the Claude Code session that requested this photograph, the running-task spinner still visible, terminals on the right, balls of yarn and project hardware surrounding the laptop"
  width={1920}
  height={1080}
  className="my-12 h-auto w-full rounded-sm"
/>
...
In daylight the proof was one comparison: the same patch of window shade, shot seconds apart at the same focus.

<BeforeAfter
  before="/images/recommission_2026-08/shade_1080p.jpg"
  after="/images/recommission_2026-08/shade_16mp.jpg"
  beforeAlt="The window shade captured in 1080p mode — the fabric reads as flat gray mush with no discernible texture"
  afterAlt="The same patch of window shade captured at the sensor's full 16 megapixels — individual threads of the weave are countable"
  beforeLabel="1080p"
  afterLabel="16 MP"
/>

At 1080p it's gray mush. At full resolution you can count the threads.
...
<Image
  src="/images/recommission_2026-08/shoe_rack_crop.jpg"
  alt="A 1:1 crop from the 16MP frame — shoe rack with legible Reynolds Wrap box text, Valet Living logo with tagline, Brooks running shoes with readable branding"
  width={850}
  height={700}
  className="my-12 h-auto w-full rounded-sm"
/>
